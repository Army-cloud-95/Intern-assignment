      ...
      {columns.map((col) => {
        ...
        return (
          <div
            ...
            className={`glass-panel rounded-2xl p-4 border border-slate-800/80 ${col.headerBorder} border-t-2 flex flex-col h-[calc(100vh-200px)] min-h-[520px] transition-all duration-300 bg-slate-950/60`}
          >
            {/* Column Header */}
            ...
            <div className="space-y-3.5 overflow-y-auto flex-1 pr-1">
              {colTasks.length === 0 ? (
                <div className="border border-dashed border-slate-800/80 rounded-2xl p-8 text-center text-slate-500 text-xs my-4 bg-slate-950/30">
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          {task.dueDate && (
                            <span className="text-[10px] font-medium text-slate-500">
                              Due {task.dueDate.split('-').slice(1).join('/')}
                            </span>
                          )}
                        </div>
