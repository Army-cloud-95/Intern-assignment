...
export default function Sidebar() {
  ...
  return (
    <aside className="w-64 glass-panel border-r border-slate-800/80 h-screen fixed left-0 top-0 z-30 flex flex-col justify-between p-4 select-none bg-slate-950/80">
      <div>
        {/* Brand Header */}
        <div className="flex items-center gap-3 px-3 py-4 mb-6 relative overflow-hidden group">
          <div className="w-10 h-10 rounded-2xl bg-gradient-to-tr from-cyan-500 via-indigo-500 to-purple-600 flex items-center justify-center shadow-glow-cyan transform group-hover:rotate-6 transition-transform duration-300">
      ...
      <div className="space-y-4">
        <div className="p-4 rounded-2xl bg-gradient-to-br from-slate-900 via-slate-900 to-indigo-950/80 border border-indigo-500/30 relative overflow-hidden shadow-lg group">
          ...
          <p className="text-[11px] text-slate-400 leading-relaxed mb-3">
            Intelligent task dispatching & workload balance active.
          </p>
          <div className="flex items-center justify-between text-[10px]">
            ...
            <span className="text-slate-500 font-medium">99.9% Uptime</span>
          </div>
        </div>

        {/* Current Active Account Profile */}
        <div className="flex items-center justify-between p-2.5 rounded-2xl bg-slate-900/90 border border-slate-800 hover:border-slate-700 transition-all">
